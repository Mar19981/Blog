...
def get_user_create_date_by_id(db: Session, sysid: int):
    return db.query(models.User.create_date).filter(models.User.sysuser == sysid).first()
...
def get_news_create_user_by_id(db: Session, sysid: int):
    return db.query(models.News.create_user).filter(models.News.sysnews == sysid).first()

def get_news_update_user_by_id(db: Session, sysid: int):
    return db.query(models.News.update_user).filter(models.News.sysnews == sysid).first()
